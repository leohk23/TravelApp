...
requested code change, commit it, push it directly to `main`, wait for the Pages
workflow, and verify the live deployment unless the user explicitly says not to
deploy that change.
